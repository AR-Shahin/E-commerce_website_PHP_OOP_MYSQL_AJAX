<?php require_once 'header.php' ?>
    ...
    <main class="main-container">
        ...
        <section id="content-block" class="slider_area" style="">
            <div class="container">
                <div class="content-push">
                    <div class="row">
                        <div id="search_content"></div>
                    </div>
                    <div class="row" id="slider_category">

                        <div class="col-md-3 col-md-push-9">
                            <div class="sidebar-navigation">
                                <div class="title">Product Categories<i class="fa fa-angle-down"></i></div>
                                <div class="list" id="front_categories">
                        ...
                        <!-- cat -->
                        <div class="col-md-9 col-md-pull-3" id="slider_c" style="overflow:hidden;">
                            <section id="popular-product" class="ecommerce">
                                <div class="container">
                                    ...
                                    <div class="shopping-content">
                                        ...
                                        <div class="row">
                                            <div id="category_wise_product"></div>
                                        </div>
                                    </div>
                            </section>

                        </div>
                        <div class="col-md-9 col-md-pull-3" id="slider">
                                        ...
                                        <div class="tp-banner tp-banner0">
                                            <ul>
                                                ...
                                                <li data-link="#" data-target="_self" data-transition="flyin" data-slotamount="7" data-masterspeed="500" data-saveperformance="on">
                                                    <!-- MAIN IMAGE --><img src="img/dummy.png" alt="slidebg1" data-lazyload="img/slide/img1.jpg" data-bgposition="left center" data-kenburns="off" data-duration="14000" data-ease="Linear.easeNone" data-bgpositionend="right center" />
                                                    <!-- LAYER NR. 1 -->
                                                ...
                                                <li data-link="#" data-target="_self" data-transition="3dcurtain-horizontal" data-slotamount="7" data-masterspeed="500" data-saveperformance="on">
                                                    <!-- MAIN IMAGE --><img src="img/dummy.png" alt="slidebg1" data-lazyload="img/slide/img2.jpg" data-bgposition="left center" data-kenburns="off" data-duration="14000" data-ease="Linear.easeNone" data-bgpositionend="right center" />
                                                    <!-- LAYER NR. 1 -->
                                                ...
                                                <li data-transition="boxslide" data-slotamount="7" data-masterspeed="500" data-saveperformance="on">
                                                    <!-- MAIN IMAGE --><img src="img/dummy.png" alt="slidebg1" data-lazyload="img/slide/img3.jpg" data-bgposition="left center" data-kenburns="off" data-duration="14000" data-ease="Linear.easeNone" data-bgpositionend="right center" />
                                                    <!-- LAYER NR. 1 -->
        ...
        if(!isset($_SESSION['cus_id'])){ ?>
            ...
            <div id="shahin">
                <p>If you want to buy something you have to login first. <br> <span style="margin-top: 10px;display:inline-block;font-size: 20px">Otherwise you may face few trouble......</span></p>
                <a href="signin.php" class="btn btn-info">Log in</a>
            </div>
        <?php } ?>
        ...
        <div class="bt-block-home-parallax" style="background-image: linear-gradient(rgba(0,0,0,.8),rgba(0,0,0,.5)),url(uploads/pexels-buenosia-carol-406152.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
